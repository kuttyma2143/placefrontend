    ...
    if (list.length > 0) {
      ...
      try {
        ...
        userDetails?.offerletterpublicid
          ...
          : null;
        const response = await fetch(
          `${import.meta.env.VITE_APP_PORT}/api/appliedplacements/${userid}`,
          {
            method: "PUT",
            body: formData,
          }
  ...
  const onNewStatusOk = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // send notification
        fetch(`${import.meta.env.VITE_APP_PORT}/api/usernotifications/${userid}`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        return (
          <div className="flex flex-wrap justify-center">
            <Dropdown
              ...
              destroyPopupOnHide={false}// this is set to true so that the Popup destroys when the Dropdown is also destroyed
